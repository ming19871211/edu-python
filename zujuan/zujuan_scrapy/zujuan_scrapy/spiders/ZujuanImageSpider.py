...
import shutil #移动文件
import imghdr
from zujuan_scrapy.settings  import rootImagPath, tmp_suffix
reload(sys)
sys.setdefaultencoding('utf8')

class ZujuanImageSpider(scrapy.Spider):
    name = "zujuan_image"

    def start_requests(self):
        for parent,dir_names,file_names in os.walk(rootImagPath):
